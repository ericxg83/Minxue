...
export const ANSWER_OCR_SYSTEM_PROMPT = [
  ...
  '  · 【高危反例，2026-09-15 八上上海作业实测】答案里含"或"字的行，如：',
  '    「9. 2或12」「14. 0或1或√2」「6. 12厘米和4厘米」「13. 4或√119/2」「8. 5或10」——',
  '    这些是**题号 N 的答案**（"或"表示多解/多答案），若误读成单元标题"N.xxx"，',
  '    其后同单元的所有答案都会错挂到假单元下，并吞掉真正的单元标题（如"第22章测试(一)""期末测试(一)"）。',
  '    判定口诀：单元标题必须含**中文课时名**（如"平方根""二次根式及其性质"）',
  '    或**栏目名**（第X章/试卷/阶段练习/期中/期末测试）；"编号. 数字或数字"形态的一律是答案行。',
  '',
  '【如果本页没有单元标题】',
