...
export const mockQuestions = [
  { id: 'q-1', task_id: 'task-1', student_id: 'student-1', content: '在平面直角坐标系 xOy 中，已知点 A(0,2)、B(1,3)，则线段 AB 的长度是？', options: ['1', '√2', '√5', '2'], answer: 'C', student_answer: 'A', is_correct: false, question_type: 'choice', subject: '数学', analysis: '根据两点间距离公式，AB = √[(1-0)² + (3-2)²] = √(1+1) = √2', created_at: '2024-04-22T20:15:00Z' },
  { id: 'q-2', task_id: 'task-1', student_id: 'student-1', content: '计算：36 ÷ (2+1) × 5 = ?', options: ['60', '30', '20', '12'], answer: 'A', student_answer: 'A', is_correct: true, question_type: 'choice', subject: '数学', analysis: '先算括号：2+1=3，然后 36÷3=12，最后 12×5=60', created_at: '2024-04-22T20:15:00Z' },
  { id: 'q-3', task_id: 'task-1', student_id: 'student-1', content: '函数 y = 2x - 3 的图象经过哪个象限？', options: ['第一、二、三象限', '第一、三、四象限', '第一、二、四象限', '第二、三、四象限'], answer: 'B', student_answer: 'C', is_correct: false, question_type: 'choice', subject: '数学', analysis: 'k=2>0，b=-3<0，所以图象经过第一、三、四象限', created_at: '2024-04-22T20:15:00Z' },
  { id: 'q-4', task_id: 'task-1', student_id: 'student-1', content: '解方程：2x + 5 = 15', options: ['x = 5', 'x = 10', 'x = 20', 'x = 7.5'], answer: 'A', student_answer: 'A', is_correct: true, question_type: 'choice', subject: '数学', analysis: '2x = 15 - 5 = 10，所以 x = 5', created_at: '2024-04-22T20:15:00Z' },
  { id: 'q-5', task_id: 'task-3', student_id: 'student-1', content: '下列各数中，是无理数的是？', options: ['0.5', '√4', 'π', '3/4'], answer: 'C', student_answer: 'B', is_correct: false, question_type: 'choice', subject: '数学', analysis: 'π 是无限不循环小数，是无理数；√4=2 是有理数', created_at: '2024-04-21T20:10:00Z' },
  { id: 'q-6', task_id: 'task-3', student_id: 'student-1', content: '一个三角形的三个内角分别是 30°、60°、90°，这是一个什么三角形？', options: ['锐角三角形', '直角三角形', '钝角三角形', '等腰三角形'], answer: 'B', student_answer: 'B', is_correct: true, question_type: 'choice', subject: '数学', analysis: '有一个角是 90° 的三角形是直角三角形', created_at: '2024-04-21T20:10:00Z' },
  { id: 'q-7', task_id: 'task-5', student_id: 'student-2', content: '已知函数 f(x) = x² + 2x + 1，求 f(2) 的值', options: ['7', '9', '11', '13'], answer: 'B', student_answer: 'A', is_correct: false, question_type: 'choice', subject: '数学', analysis: 'f(2) = 2² + 2×2 + 1 = 4 + 4 + 1 = 9', created_at: '2024-04-22T19:15:00Z' },
  { id: 'q-8', task_id: 'task-5', student_id: 'student-2', content: '计算：(-3)² = ?', options: ['-9', '9', '6', '-6'], answer: 'B', student_answer: 'B', is_correct: true, question_type: 'choice', subject: '数学', analysis: '负数的偶次幂为正，(-3)² = 9', created_at: '2024-04-22T19:15:00Z' },
  { id: 'q-9', task_id: 'task-7', student_id: 'student-3', content: '若 a > b > 0，则下列不等式正确的是？', options: ['a² < b²', 'a² > b²', 'a² = b²', '无法判断'], answer: 'B', student_answer: 'A', is_correct: false, question_type: 'choice', subject: '数学', analysis: 'a > b > 0 时，两边同时平方得 a² > b²', created_at: '2024-04-22T17:15:00Z' },
  { id: 'q-10', task_id: 'task-7', student_id: 'student-3', content: '化简：√18 = ?', options: ['3√2', '2√3', '6', '9'], answer: 'A', student_answer: 'A', is_correct: true, question_type: 'choice', subject: '数学', analysis: '√18 = √(9×2) = 3√2', created_at: '2024-04-22T17:15:00Z' },
  { id: 'q-11', task_id: 'task-9', student_id: 'student-4', content: '一次函数 y = -2x + 4 的斜率是？', options: ['2', '-2', '4', '-4'], answer: 'B', student_answer: 'B', is_correct: true, question_type: 'choice', subject: '数学', analysis: '一次函数 y = kx + b 中，k 即为斜率，这里 k = -2', created_at: '2024-04-22T15:15:00Z' },
  { id: 'q-12', task_id: 'task-9', student_id: 'student-4', content: '解不等式：3x - 6 > 0', options: ['x > 2', 'x < 2', 'x > -2', 'x < -2'], answer: 'A', student_answer: 'C', is_correct: false, question_type: 'choice', subject: '数学', analysis: '3x > 6，所以 x > 2', created_at: '2024-04-22T15:15:00Z' }
]
