...
export default function ProcessingPage({
  ...
  // 批改中时按 5s 拉一次，让 result.progress 的 sub-step 能落到 UI。
  // 所有任务都已结算（done / failed）就停，避免无效轮询。
  const hasInFlight = processingTasks.length > 0 || waitingTasks.length > 0
